...
# ssl:verify-certificate no = 接受實驗室自簽憑證（內部信任 NAS）
LFTP_PRE="set ssl:verify-certificate no; set ftp:charset $FTP_CHARSET; set file:charset utf-8; set net:connection-limit 4;"
